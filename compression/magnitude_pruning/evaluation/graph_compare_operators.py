...
generate_graph(results_by_model, pruning_ratios, "magnitude_pruning", "Pruning Ratio", "%", savefile="compression/magnitude_pruning/evaluation/all_magnitude_pruning_performance.png")
